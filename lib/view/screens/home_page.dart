...
import 'package:news_app/view/screens/webview_news.dart';
import 'package:news_app/view/widgets/news_card.dart';
import 'package:news_app/view/widgets/side_drawer.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar('ABC News', context, actions: [
        IconButton(
          onPressed: () {
